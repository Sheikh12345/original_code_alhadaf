                                ...
                                child:    Container(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                        ...
                                        Row(
                                          children: [
                                            Text(languageName=="ar"?' مركز اللعب:':'Position:',style: TextStyle(fontFamily: 'Cairo',fontSize: 12,color: Colors.grey[800],fontWeight: FontWeight.bold),),
                                            SizedBox(width: 5,),
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Text(languageName=="ar"?' تاريخ الميلاد:':"Date of Birth:",style: TextStyle(fontFamily: 'Cairo',fontSize: 12,color: Colors.grey[800],fontWeight: FontWeight.bold),),
                                              SizedBox(width: 5,),
