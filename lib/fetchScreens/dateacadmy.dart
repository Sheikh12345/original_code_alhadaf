          ...
          child: ListView(
            children: [
              ...
              Align(
                ...
                child: Text(
                  languageName=="ar"?  'مواعيد الاكاديميات':"Date of academy",
              ...
              StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection(languageName=="ar"?"dateAcadmy":'dateAcadmyEnglishVer')
                      .snapshots(),
                  builder: (ctx, snapshot) {
                    if (snapshot.hasError) {
                      return Text(languageName=="ar"?"برجاء التاكد من الانترنت":'Check your internet');
                    }
