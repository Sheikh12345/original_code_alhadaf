            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    languageName=="ar"? 'حجز اختبارات النادي':"Clubs booking",
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value.isEmpty) {
                        return languageName=="ar"?'سنة الميلاد لا يمكن ان يكون فارغ':"DOB cannot be empty";
                      }
                      return null;
                    },
                    onSaved: (value) {
                    ...
                    decoration: InputDecoration(
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(20)),
                        labelText:languageName=="ar"? 'سنة الميلاد':"Date of birth"),
                    style: stylefield,
                  ),
                  SizedBox(height: 10),
                  TextFormField(
                  ...
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: MaterialButton(
                          ...
                          child: Text(languageName=="ar"?'التالي ':"Next",style: TextStyle(fontFamily: 'Cairo',color: Colors.white,fontSize: 18)),
                          onPressed: () {
